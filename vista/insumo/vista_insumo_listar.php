  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      <div class="modal-header" style="text-align: center;">
        ...
        <h4 class="modal-title">Registro de Insumo Medico</h4>
      </div>
      <div class="modal-body">
        <div class="col-lg-12">
          <label for="">Nombre</label>
          <input type="text" class="form-control" id="txt_insumo" placeholder="Escriba insumo medico" onkeypress="return soloLetras(event)"><br>
        </div>
        <div class="col-lg-12">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Registrar_Insumo()"> <i class="fa fa-check"></i>&nbsp; Registrar</button>
...
<div class="modal fade" id="modal_editar" role="dialog">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-lg-12">
          <input type="hidden" id="txt_idinsumo">
          <label for="">Nombre</label>
          <input type="hidden" id="txt_insumo_actual_editar" placeholder="Escriba insumo medico" onkeypress="return soloLetras(event)">       
          <input type="text" class="form-control" id="txt_insumo_nuevo_editar" placeholder="Escriba insumo medico" onkeypress="return soloLetras(event)"><br>
        </div>
        <div class="col-lg-12">
          <label for="">Stock</label>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" onclick="Modificar_Insumo()"> <i class="fa fa-check"></i>&nbsp; Modificar</button>
        <button type="button" class="btn btn-danger" data-dismiss="modal"> <i class="fa fa-close"></i>&nbsp; Cerrar</button>
      </div>
    </div>
  </div>
